...
) # spatial data takes a long time to render in the plot windows, so it's nice to not show them, just save and open
```
...
# large image class is a type of object, easier to interact with
```
...
#feat_type : "rna"
#provenance: cell
# shows layers and how to aggregate data
```
